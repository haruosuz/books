...
Sequence analysis is a broad field, covering any kinds of analyses of textual sequences; e.g. those representing genomes (sequences of [nucleotides](https://www.ddbj.nig.ac.jp/ddbj/code-e.html#nucleotide-1)) and proteins (sequences of [amino acids](https://www.ddbj.nig.ac.jp/ddbj/code-e.html#amino-1)).  
...
生命科学分野における有用な情報を紹介するウェブサイトです。
だれでも自由に閲覧し再利用することができます。
・データベースやツールの動画マニュアル
・講演や講習会動画、資料
・イラスト
...
<img src="http://www.uniprot.org/images/overview.png" alt="http://www.uniprot.org/help/about" width=25%>
